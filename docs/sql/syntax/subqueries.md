...
can also be used to define a subquery that selects a single value
...
`VARCHAR` or `VARBINARY` type. The `SELECT` list for `subquery`
...
[evaluation-rules-subqueries]: #evaluation-rules_subqueries
[example-tables]: #example-tables
[correlated_subquery_concepts]: #correlated-subquery_concepts
[subqueries-query-syntax]: query_syntax.md
[in-operator]: operators.md#in-operators
[array-function]: ../functions/array_functions.md#array
[aggregate-functions]: ../functions/aggregate_functions.md
[semantic-rules-in]: operators.md#semantic-rules_in
[quantified-like]: operators.md#like-operator_quantified
[semantic-rules-like]: operators.md#semantic-rules_like
[quantified-like]: operators.md#like-operator_quantified
