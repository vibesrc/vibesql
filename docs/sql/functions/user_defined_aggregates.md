...
SQL supports user-defined aggregate functions (UDAs).
...
[aggregate-udf-parameters]: #aggregate-udf_parameters
[group-by-link]: ../syntax/query_syntax.md#group-by_clause
[aggregate-fns-link]: aggregate_function_calls.md
