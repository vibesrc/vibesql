...
SQL supports the following array functions.
...
| [`ARRAY_AGG`](aggregate_functions.md#array-agg)                            | Gets an array of values. For more information, see [Aggregate functions](aggregate_functions.md).                                                                                  |
| [`ARRAY_AVG`](array_functions.md#array-avg)                                | Gets the average of non-`NULL` values in an array.                                                                                                                                 |
| [`ARRAY_CONCAT`](array_functions.md#array-concat)                          | Concatenates one or more arrays with the same element type into a single array.                                                                                                    |
| [`ARRAY_CONCAT_AGG`](aggregate_functions.md#array-concat-agg)              | Concatenates arrays and returns a single array as a result. For more information, see [Aggregate functions](aggregate_functions.md).                                               |
| [`ARRAY_FILTER`](array_functions.md#array-filter)                          | Takes an array, filters out unwanted elements, and returns the results in a new array.                                                                                             |
| [`ARRAY_FIRST`](array_functions.md#array-first)                            | Gets the first element in an array.                                                                                                                                                |
| [`ARRAY_INCLUDES`](array_functions.md#array-includes)                      | Checks if there is an element in the array that is equal to a search value.                                                                                                        |
| [`ARRAY_INCLUDES_ALL`](array_functions.md#array-includes-all)              | Checks if all search values are in an array.                                                                                                                                       |
| [`ARRAY_INCLUDES_ANY`](array_functions.md#array-includes-any)              | Checks if any search values are in an array.                                                                                                                                       |
| [`ARRAY_IS_DISTINCT`](array_functions.md#array-is-distinct)                | Checks if an array contains no repeated elements.                                                                                                                                  |
| [`ARRAY_LAST`](array_functions.md#array-last)                              | Gets the last element in an array.                                                                                                                                                 |
| [`ARRAY_LENGTH`](array_functions.md#array-length)                          | Gets the number of elements in an array.                                                                                                                                           |
| [`ARRAY_MAX`](array_functions.md#array-max)                                | Gets the maximum non-`NULL` value in an array.                                                                                                                                     |
| [`ARRAY_MIN`](array_functions.md#array-min)                                | Gets the minimum non-`NULL` value in an array.                                                                                                                                     |
| [`ARRAY_REVERSE`](array_functions.md#array-reverse)                        | Reverses the order of elements in an array.                                                                                                                                        |
| [`ARRAY_SLICE`](array_functions.md#array-slice)                            | Produces an array containing zero or more consecutive elements from an input array.                                                                                                |
| [`ARRAY_SUM`](array_functions.md#array-sum)                                | Gets the sum of non-`NULL` values in an array.                                                                                                                                     |
| [`ARRAY_TO_STRING`](array_functions.md#array-to-string)                    | Produces a concatenation of the elements in an array as a `VARCHAR` value.                                                                                                         |
| [`ARRAY_TRANSFORM`](array_functions.md#array-transform)                    | Transforms the elements of an array, and returns the results in a new array.                                                                                                       |
| [`ARRAY_ZIP`](array_functions.md#array-zip)                                | Combines elements from two to four arrays into one array.                                                                                                                          |
| [`FLATTEN`](array_functions.md#flatten)                                    | Flattens arrays of nested data to create a single flat array.                                                                                                                      |
| [`GENERATE_ARRAY`](array_functions.md#generate-array)                      | Generates an array of values in a range.                                                                                                                                           |
| [`GENERATE_DATE_ARRAY`](array_functions.md#generate-date-array)            | Generates an array of dates in a range.                                                                                                                                            |
| [`GENERATE_RANGE_ARRAY`](range_functions.md#generate-range-array)          | Splits a range into an array of subranges. For more information, see [Range functions](range_functions.md).                                                                        |
| [`GENERATE_TIMESTAMP_ARRAY`](array_functions.md#generate-timestamp-array)  | Generates an array of timestamps in a range.                                                                                                                                       |
| [`JSON_ARRAY`](json_functions.md#json-array)                               | Creates a JSON array. For more information, see [JSON functions](json_functions.md).                                                                                               |
| [`JSON_ARRAY_APPEND`](json_functions.md#json-array-append)                 | Appends JSON data to the end of a JSON array. For more information, see [JSON functions](json_functions.md).                                                                       |
| [`JSON_ARRAY_INSERT`](json_functions.md#json-array-insert)                 | Inserts JSON data into a JSON array. For more information, see [JSON functions](json_functions.md).                                                                                |
| [`JSON_EXTRACT_ARRAY`](json_functions.md#json-extract-array)               | (Deprecated) Extracts a JSON array and converts it to a SQL `ARRAY<JSON-formatted VARCHAR>` or `ARRAY<JSON>` value. For more information, see [JSON functions](json_functions.md). |
| [`JSON_EXTRACT_STRING_ARRAY`](json_functions.md#json-extract-string-array) | (Deprecated) Extracts a JSON array of scalar values and converts it to a SQL `ARRAY<VARCHAR>` value. For more information, see [JSON functions](json_functions.md).                |
| [`JSON_QUERY_ARRAY`](json_functions.md#json-query-array)                   | Extracts a JSON array and converts it to a SQL `ARRAY<JSON-formatted VARCHAR>` or `ARRAY<JSON>` value. For more information, see [JSON functions](json_functions.md).              |
| [`JSON_VALUE_ARRAY`](json_functions.md#json-value-array)                   | Extracts a JSON array of scalar values and converts it to a SQL `ARRAY<VARCHAR>` value. For more information, see [JSON functions](json_functions.md).                             |
...
- If the subquery returns an `ARRAY` typed column or `ARRAY` typed rows, the
  `ARRAY` function returns an error that SQL doesn't support
...
[datamodel-sql-tables]: ../types/data_model.md#standard-sql_tables
...
[floating-point-types]: ../types/data_types.md#floating-point_types
[non-deterministic]: ../types/data_types.md#floating-point_semantics
...
| INPUT  | `INTEGER` | `BIGINT` | `UINTEGER` | `UBIGINT` | `NUMERIC` | `NUMERIC` | `FLOAT`  | `DOUBLE` | `INTERVAL` |
| ------ | --------- | -------- | ---------- | --------- | --------- | --------- | -------- | -------- | ---------- |
| OUTPUT | `DOUBLE`  | `DOUBLE` | `DOUBLE`   | `DOUBLE`  | `NUMERIC` | `NUMERIC` | `DOUBLE` | `DOUBLE` | `INTERVAL` |
...
[array-link-to-operators]: ../syntax/operators.md
...
[lambda-definition]: functions_reference.md#lambdas
...
- [Signature 1](#array-includes-signature1):
  `ARRAY_INCLUDES(array_to_search, search_value)`
- [Signature 2](#array-includes-signature2):
...
| INPUT  | `INTEGER` | `BIGINT` | `UINTEGER` | `UBIGINT` | `NUMERIC` | `NUMERIC` | `FLOAT`  | `DOUBLE` | `INTERVAL` |
| ------ | --------- | -------- | ---------- | --------- | --------- | --------- | -------- | -------- | ---------- |
| OUTPUT | `BIGINT`  | `BIGINT` | `UBIGINT`  | `UBIGINT` | `NUMERIC` | `NUMERIC` | `DOUBLE` | `DOUBLE` | `INTERVAL` |
...
Returns a concatenation of the elements in `array_expression` as a `VARCHAR`
or `VARBINARY` value. The value for `array_expression` can
either be an array of `VARCHAR` or `VARBINARY` data type.
...
- `VARCHAR` for a function signature with `VARCHAR` input.
- `VARBINARY` for a function signature with `VARBINARY` input.
...
- `mode`: A named argument with a `VARCHAR` value. Determines how arrays of
...
[implicit-aliases]: ../syntax/query_syntax.md#implicit-aliases## `FLATTEN`
...
For more examples, including how to use with `FLATTEN`, see the
[array elements field access operator][array-el-field-operator].

[flatten-tree-to-array]: ../types/arrays.md#flattening-nested_data_into_arrays
[array-el-field-operator]: ../syntax/operators.md#array-el_field_operator
...
```sql
GENERATE_DATE_ARRAY(start_date, end_date[, INTERVAL BIGINT_expr date_part])
```
...
- `BIGINT_expr` must be an `BIGINT`.
- `date_part` must be either DAY, WEEK, MONTH, QUARTER, or YEAR.

The `BIGINT_expr` parameter determines the increment used to generate dates. The
default value for this parameter is 1 day.

This function returns an error if `BIGINT_expr` is set to 0.
...
[accessing-array-elements]: ../types/arrays.md#accessing-array_elements
