...
SQL supports the following time series functions.

### Function list

| Name                                    | Summary                                                                 |
| --------------------------------------- | ----------------------------------------------------------------------- |
| [`DATE_BUCKET`](#date-bucket)           | Gets the lower bound of the date bucket that contains a date.           |
| [`DATETIME_BUCKET`](#datetime-bucket)   | Gets the lower bound of the datetime bucket that contains a datetime.   |
| [`TIMESTAMP_BUCKET`](#timestamp-bucket) | Gets the lower bound of the timestamp bucket that contains a timestamp. |
...
[interval-range]: ../types/data_types.md#range-datetime_part_interval
[interval-parts]: ../types/data_types.md#interval-datetime_parts
