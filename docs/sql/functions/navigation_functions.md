...
SQL supports navigation functions.
...
| Name                                                         | Summary                                                                    |
| ------------------------------------------------------------ | -------------------------------------------------------------------------- |
| [`FIRST_VALUE`](navigation_functions.md#first-value)         | Gets a value for the first row in the current window frame.                |
| [`LAG`](navigation_functions.md#lag)                         | Gets a value for a preceding row.                                          |
| [`LAST_VALUE`](navigation_functions.md#last-value)           | Gets a value for the last row in the current window frame.                 |
| [`LEAD`](navigation_functions.md#lead)                       | Gets a value for a subsequent row.                                         |
| [`NTH_VALUE`](navigation_functions.md#nth-value)             | Gets a value for the Nth row of the current window frame.                  |
| [`PERCENTILE_CONT`](navigation_functions.md#percentile-cont) | Computes the specified percentile for a value, using linear interpolation. |
| [`PERCENTILE_DISC`](navigation_functions.md#percentile-disc) | Computes the specified percentile for a discrete value.                    |
...
table.
| INPUT | `NUMERIC` | `NUMERIC` | `DOUBLE` |
|-------|----------------------|-------------------------|---------------------|
| `NUMERIC` | `NUMERIC` | `NUMERIC` | `DOUBLE` |
| `NUMERIC` | `NUMERIC` | `NUMERIC` | `DOUBLE` |
