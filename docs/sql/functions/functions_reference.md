...
The following rules apply to all built-in SQL functions unless
...
```sql
CountTokensInText(paragraph VARCHAR, tokens ARRAY, delimiters VARCHAR)
```
...
For some functions, SQL supports lambdas as builtin function
...
[lambdas]: #lambdas
[link-to-operators]: ../syntax/operators.md
[link-to-SAFE_DIVIDE]: mathematical_functions.md#safe-divide
[link-to-CAST]: conversion_functions.md#safe-casting
