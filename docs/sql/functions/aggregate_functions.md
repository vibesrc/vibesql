...
SQL supports the following general aggregate functions.
...
| Name                                                          | Summary                                                                                                                  |
| ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| [`ANY_VALUE`](aggregate_functions.md#any-value)               | Gets an expression for some row.                                                                                         |
| [`ARRAY_AGG`](aggregate_functions.md#array-agg)               | Gets an array of values.                                                                                                 |
| [`ARRAY_CONCAT_AGG`](aggregate_functions.md#array-concat-agg) | Concatenates arrays and returns a single array as a result.                                                              |
| [`AVG`](aggregate_functions.md#avg)                           | Gets the average of non-`NULL` values.                                                                                   |
| [`BIT_AND`](aggregate_functions.md#bit-and)                   | Performs a bitwise AND operation on an expression.                                                                       |
| [`BIT_OR`](aggregate_functions.md#bit-or)                     | Performs a bitwise OR operation on an expression.                                                                        |
| [`BIT_XOR`](aggregate_functions.md#bit-xor)                   | Performs a bitwise XOR operation on an expression.                                                                       |
...
| [`LOGICAL_AND`](aggregate_functions.md#logical-and)           | Gets the logical AND of all non-`NULL` expressions.                                                                      |
| [`LOGICAL_OR`](aggregate_functions.md#logical-or)             | Gets the logical OR of all non-`NULL` expressions.                                                                       |
...
| [`STRING_AGG`](aggregate_functions.md#string-agg)             | Concatenates non-`NULL` `VARCHAR` or `VARBINARY` values.                                                                 |
...
[countif]: aggregate_functions.md#countif
[groupable-data-types]: ../types/data_types.md#groupable-data_types
...
```sql
SELECT COUNTIF(x0) AS num_positive
...
[count]: aggregate_functions.md#count
...
[agg-data-type-properties]: ../types/data_types.md#data-type_properties
...
Returns a value (either `VARCHAR` or `VARBINARY`) obtained by concatenating
